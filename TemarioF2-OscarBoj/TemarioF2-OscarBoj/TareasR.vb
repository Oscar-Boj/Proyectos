...
Public Class TareasR
    ...
    Private Sub TareasR_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            Dim da As New MySqlDataAdapter("select * from tareas where id_responsable = '" + Form1.id_usuario_sesion.ToString + "'", con)
    ...
    Private Sub btn_crearT_Click(sender As Object, e As EventArgs) Handles btn_crearT.Click
        ...
        If txt_tarea.Text <> "" Then
            sentencia = "INSERT INTO tareas (descripcion, fecha_asignacion, estado, id_tecnico, id_responsable) VALUES ('" & txt_tarea.Text & "', '" & fechaActual & "', '" & estado & "', NULL, " & idResponsable & ")"
